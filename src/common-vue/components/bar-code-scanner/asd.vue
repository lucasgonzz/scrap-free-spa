...
vue-barcode-scanner
Public
Fork your own copy of undecaf/vue-barcode-scanner
Code
Issues
Pull requests
Actions
...
vue-barcode-scanner/example/src/Example.vue
@undecaf
undecaf Add an esbuild build script for the online example
Latest commit 4abc1e0 on Mar 15
 History
 1 contributor
657 lines (566 sloc)  19.6 KB
